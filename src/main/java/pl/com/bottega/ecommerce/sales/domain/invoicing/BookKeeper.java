...
public class BookKeeper {
    ...
    public Invoice issuance(InvoiceRequest invoiceRequest, TaxCalculator taxCalculator) {
        ...
        for (RequestItem requestItem : invoiceRequest.getItems()) {
            ...
            InvoiceLine invoiceLine = invoiceLineFactory.createInvoiceLine(requestItem.getProductData(),
                    requestItem.getQuantity(), requestItem.getTotalCost(), taxCalculator.calculateTax(requestItem));
